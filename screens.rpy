...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Create New") action Start()
        ...
        if _in_replay:
            ...
            textbutton _("Log-In Screen") action MainMenu()
...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Codes and Storyline by TheGreatTheorist\nUI and UX by\n")
            text _("Music List\n\nBlissful Ignorance\nSecretHush\n\nCrisis Calls\nSecretHush\n\nPleasant Chat\nSecretHush\n\nDisconnected\nSecretHush")
            text _("\nDreaming Butterfly\nSecretHush")
            text _("\nHoping to see you with more love!\n\n")
...
# Chat Window mode
#
# Screen for main game purposes. Use NVL as basic or manipulate the whole
# system using image operations (with dynamic memory usage as tradeoff).
# Try to combine both NVL and ADV (say screen)!
...
screen phone_message(who, what):
    ...
    vbox at incoming_message:
        style_group "phone_message"
        #add "images/bubble-tip.png" at Position(xalign = 0.01, yalign = 0.10)
        frame:
            style_group "phone_message"
            xsize 640
            vbox:
                #add "images/bubble-tip.png"
                style "phone_message_contents"
                hbox:   
...
screen phone_message3(who, what):
    #xalign xloc
    #yalign yloc
    vbox at incoming_message3:
        style_group "phone_message"
        #add "images/bubble-tip.png" at Position(xalign = 0.01, yalign = 0.10)
        frame:
            style_group "phone_message"
...
screen player_phone_message(who, what):
    vbox at incoming_message:
    #vbox:
        style_group "phone_message"
        xoffset 480
...
screen player_phone_message2(who, what):
    vbox at incoming_message2:
    #vbox:
        style_group "phone_message"
        xoffset 480
...
screen player_phone_message3(who, what):
    vbox at incoming_message3:
    #vbox:
        style_group "phone_message"
        xoffset 480
...
screen player_phone_message4(who, what):
    vbox at incoming_message4:
    #vbox:
        style_group "phone_message"
        xoffset 480
...
screen phone_reply(reply1, label1, reply2, label2, reply3, label3):
    modal True
    vbox:
        xalign 0.5
        yalign 0.4
...
init +1 python:
    ...
    for gal_item in gallery_cg_items:
        renpy.image (gal_item + " butt", im.Scale((gal_item), thumbnail_x, thumbnail_y))
    #for gal_item in gallery_bg_items:
